...
//   var editorData2= CKEDITOR.instances['editor2'].getData();
    ...
    $.ajax({
        ...
        //   App.unblockUI("#myForm");
            ...
            {
            //   swal("Error!", obj.msg, "console.error();");
                $("#error1").html(obj.msg);
                $("#success1").html("");
...
{
    // var objEditor1 = CKEDITOR.instances["content"];
    // var page_content = objEditor1.getData();
